...
\begin{document}
	...
	%	\vspace{1\baselineskip}
		...
		\begin{table}[H]
			\begin{tabular}{llr}
				\textbf{Matrikelnummer}                &  \includegraphics[width=0.05\textwidth]{images/weißerplaceholder.png} & 5183010                                                                \\
				\textbf{Ausbildungsfirma}           &   & \begin{tabular}[c]{@{}l@{}}Wirl Elektrotechnik GmbH\end{tabular} \\
				\textbf{Gruppenmitglieder} && Cedric Franke, Sven Mößner, Niklas Stein \\
